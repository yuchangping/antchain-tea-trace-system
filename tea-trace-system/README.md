...
从现在开始，推荐按下面顺序阅读和推进项目：

1. [`../AGENTS.md`](../AGENTS.md)：项目总入口，规定先做什么、后做什么、重大改动如何闭环、Git 如何保护回退
2. [`../茶叶溯源系统项目进度总表.md`](../茶叶溯源系统项目进度总表.md)：项目驾驶舱，记录当前阶段、里程碑、问题、下一步
3. [`../茶叶溯源系统分阶段工作流程.md`](../茶叶溯源系统分阶段工作流程.md)：从开始到完成的阶段拆分、任务清单、验收标准
4. `docs/`：专题文档，按架构、接口、数据库、演示脚本分别维护

如果以后继续开发，默认先看 `AGENTS.md`，再决定要读哪一份细分文档。
